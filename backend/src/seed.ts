...
const products = [
  ...
  { name: 'Fruit Roll-Up', price: 1.50, category: 'candy', description: 'A bright, chewy fruit snack roll with a glossy finish. Sweet strawberry flavor kids and grown-ups both enjoy.', barcode: '5901234123538', imageUrl: 'https://shophollywoodcandy.com/wp-content/uploads/2023/07/hollywood-candy-fruit-roll-up-2.png' },
  ...
  { name: 'Beef Jerky', price: 5.25, category: 'healthy', description: 'Lean strips of beef slow-cooked with a smoky teriyaki glaze. High in protein and full of savory flavor.', barcode: '5901234123541', imageUrl: 'https://static.vecteezy.com/system/resources/thumbnails/038/280/523/small/ai-generated-fresh-and-delicious-beef-jerky-pieces-isolated-on-transparent-background-free-png.png' },
  { name: 'Chocolate Wafers', price: 2.25, category: 'snacks', description: 'Layered wafer sticks enrobed in smooth milk chocolate. Crisp, light and melt-in-your-mouth delicious.', barcode: '5901234123542', imageUrl: 'https://static.vecteezy.com/system/resources/previews/052/552/823/non_2x/delicious-stacked-chocolate-waffles-with-whipped-cream-and-syrup-isolated-on-transparent-background-png.png' },
  { name: 'Lollipops', price: 1.25, category: 'candy', description: 'A bright assortment of classic swirl lollipops. Sweet, colorful and made for sharing with a little one.', barcode: '5901234123543', imageUrl: 'https://static.vecteezy.com/system/resources/previews/047/490/436/non_2x/colorful-lollipops-isolated-on-a-transparent-background-free-png.png' },
  { name: 'Mixed Nuts', price: 4.50, category: 'healthy', description: 'A roasted medley of almonds, cashews, pecans and peanuts. A satisfying crunchy blend with a hint of sea salt.', barcode: '5901234123544', imageUrl: 'https://static.vecteezy.com/system/resources/previews/051/422/080/non_2x/mixed-nuts-ball-isolated-on-transparent-background-free-png.png' },
  ...
  { name: 'Marshmallows', price: 2.00, category: 'candy', description: 'Pillowy soft marshmallows with a sweet vanilla flavor. Great for s\u2019mores, hot chocolate or straight out of the bag.', barcode: '5901234123546', imageUrl: 'https://static.vecteezy.com/system/resources/previews/053/457/987/non_2x/plate-with-pink-and-blue-marshmallows-free-png.png' },
]
